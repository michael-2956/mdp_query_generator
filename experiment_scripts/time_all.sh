...
# ./target/release/equivalence_testing configs/only_queries_config_tpcds.toml -n $n_queries > experiment_results/our_tpcds_10K_balanced.txt
...
# ../sqlsmith/sqlsmith --dry-run --target="host=localhost port=5432 dbname=tpcds" --max-queries=$n_queries --seed=0 2>/dev/null > experiment_results/sqlsmith_tpcds_10K.txt

# echo
# echo "Our node mean:"
# python3 experiment_scripts/count_ast_nodes.py experiment_results/our_10K_balanced.txt 

# echo
# echo "SQLSmith node mean:"
# python3 experiment_scripts/count_ast_nodes.py experiment_results/sqlsmith_10K.txt
# python3 experiment_scripts/count_ast_nodes.py experiment_results/sqlsmith_tpcds_10K.txt

# echo "Measuring query size per anticall value..."
# for i in {1..24}
# do
#    echo
#    echo n: $n_queries --anticall_stir_level $i
#    ./target/release/equivalence_testing configs/only_queries_config.toml -n $n_queries --anticall_stir_level $i > experiment_results/st/$i.sql
#    python3 experiment_scripts/count_ast_nodes.py experiment_results/st/$i.sql
# done
