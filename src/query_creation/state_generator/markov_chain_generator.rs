...
impl<StC: StateChooser> MarkovChainGenerator<StC> {
    pub fn with_config(config: &StateGeneratorConfig) -> Result<Self, SyntaxError> {
        ...
        _self.register_value_setter(LimitIsNotPresentValueSetter {});
        _self.register_stateless_call_modifier(LimitIsNotPresentModifier {});
        _self.register_value_setter(OrderByPresentValueSetter {});
        _self.register_stateless_call_modifier(OrderByPresentModifier {});
